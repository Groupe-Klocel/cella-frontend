...
export const CustomerOrderModelV2: ModelType = {
    ...
    fieldsInfo: {
        ...
        // effective carrier id (via the shipping mode) — used to narrow/keep-consistent
        // load & appointment candidates on a carrier basis (order has no direct carrierId)
