...
export const AiMessageModelV2: ModelType = {
    tableName: 'AI_MESSAGE', // Table.AiMessage once the backend schema reaches staging
    resolverName: 'AiMessage',
    isEditable: false,
    isDeletable: false,
