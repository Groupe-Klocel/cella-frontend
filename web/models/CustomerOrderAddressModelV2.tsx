...
export const CustomerOrderAddressModelV2: ModelType = {
    tableName: Table.OrderAddress,
    resolverName: 'OrderAddress',
    isEditable: true,
    isDeletable: true,
    ...
    endpoints: {
        detail: 'orderAddress',
        list: 'orderAddresses',
        create: 'createOrderAddress',
        update: 'updateOrderAddress',
    ...
    fieldsInfo: {
        ...
        entityCode: {
            ...
            isDetailRequested: true,
            isExcludedFromDetail: false,
            detailGroup: '{"label":"Address", "position":2}',
            link: null,
            addEditFormat: 'String',
            addEditStep: null,
            maxLength: 30,
