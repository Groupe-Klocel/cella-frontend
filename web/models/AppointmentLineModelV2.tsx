...
export const AppointmentLineModelV2: ModelType = {
    tableName: Table.AppointmentLine,
    resolverName: 'AppointmentLine',
    isEditable: true,
    isDeletable: false,
    isSoftDeletable: true,

    endpoints: {
        detail: 'appointmentLine',
        list: 'appointmentLines',
        create: 'createAppointmentLine',
        update: 'updateAppointmentLine',
        delete: 'deleteAppointmentLine',
        softDelete: 'softDeleteAppointmentLine',
        export: true
    },
