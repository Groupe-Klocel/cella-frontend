...
export const WarehouseWorkerModel: ModelType = {
    ...
    detailFields: ['id', 'username', 'email', 'created', 'createdBy', 'modified', 'modifiedBy'],
    listFields: ['id', 'username', 'email', 'created', 'createdBy', 'modified', 'modifiedBy'],
    sortableFields: ['username', 'email', 'created', 'createdBy', 'modified', 'modifiedBy'],
