...
export const HandlingUnitOutboundModelV2: ModelType = {
    ...
    fieldsInfo: {
        ...
        name: {
            ...
            addEditStep: null,
            maxLength: null,
            displayName: 'hanldingUnitOutboundName',
            isMandatory: false,
            minRule: null,
            maxRule: null,
            config: null,
        ...
        // rendered as a clickable link opening a new tab (http(s) strings are
        // auto-linked by ListComponentV2 / DetailsList)
        carrierTrackingUrl: {
            isListRequested: true,
            isDefaultHiddenList: false,
            isExcludedFromList: false,
        ...
        roundId: {
            ...
            param: null,
            optionTable:
                '{"table": "Round", "fieldToDisplay": "name","filtersToApply":{"category":["71210"]}}'
        },
        'round{name}': {
            isListRequested: true,
            isDefaultHiddenList: false,
