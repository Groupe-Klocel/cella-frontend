...
import { AddPurchaseOrderForm } from '../Forms/AddPurchaseOrderForm';
...
export interface IAddPurchaseOrderProps {
    headerComponent: any;
    dataModel: ModelType;
...
const AddPurchaseOrder: FC<IAddPurchaseOrderProps> = (props: IAddPurchaseOrderProps) => {
...
AddPurchaseOrder.displayName = 'AddPurchaseOrder';
