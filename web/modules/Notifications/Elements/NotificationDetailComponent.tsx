...
const NotificationDetailComponent: FC<ISingleItemProps> = (props: ISingleItemProps) => {
...
NotificationDetailComponent.displayName = 'NotificationDetailComponent';

export { NotificationDetailComponent };
