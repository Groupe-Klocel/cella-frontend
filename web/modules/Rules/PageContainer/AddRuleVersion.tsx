...
import { AddRuleVersionForm } from '../Forms/AddRuleVersionForm';
...
const AddRuleVersion = (props: ISingleItemProps) => {
    ...
    const breadsCrumb = [
        ...
        {
            breadcrumbName: t('add2', { name: t('common:rule-version') })
        }
    ];
                ...
                !modes.includes(ModeEnum.Create) ? (
                    ...
                    <>
                        <HeaderContent
                            ...
                            routes={breadsCrumb}
                            onBack={() => router.push('/rules/' + props?.ruleId)}
                        />
                        <StyledPageContent>
                            <AddRuleVersionForm ruleId={props.ruleId} ruleName={props.ruleName} />
                        </StyledPageContent>
                    </>
                )
            ) : (
