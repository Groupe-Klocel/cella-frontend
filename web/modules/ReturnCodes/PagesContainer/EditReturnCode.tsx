...
import { returnCodeRoutes } from '../Static/ReturnCodeRoutes';
        ...
        <>
            {permissions ? (
                !modes.includes(ModeEnum.Update) ? (
                    ...
                    <>
                        <HeaderContent
                            title={`${t('menu:return-code')} - ${data?.parameter?.value}`}
                            routes={breadsCrumb}
                            onBack={() => router.back()}
                        />
                        <StyledPageContent>
                            {data && !isLoading ? (
                                <EditReturnCodeForm returnCodeId={id} details={data?.parameter} />
                            ) : (
                                <ContentSpin />
                            )}
                        </StyledPageContent>
