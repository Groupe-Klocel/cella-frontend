...
const DeliveryExtrasListComponent = (props: IListProps) => {
            ...
            if (listData && listData['results']) {
                ...
                if (listData['results'].length > 0) {
                    ...
                    if (
                        ...
                        props.dataModel.modelName === 'DeliveryExtras'
                    ) {
...
DeliveryExtrasListComponent.displayName = 'ListWithFilter';
export { DeliveryExtrasListComponent };
