...
const DragAndDropListComponent = (props: IListProps) => {
    ...
    const handleTableChange = async (_pagination: any, _filter: any, sorter: any) => {
        ...
        console.log('handleTableChange newSorter', newSorter);
...
DragAndDropListComponent.displayName = 'DragAndDropListWithFilter';
