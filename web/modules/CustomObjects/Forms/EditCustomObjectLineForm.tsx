...
export type EditCustomObjectLineFormProps = {
    customObjectLineId: string;
    details: any;
};

export const EditCustomObjectLineForm: FC<EditCustomObjectLineFormProps> = ({
    customObjectLineId,
    details
}: EditCustomObjectLineFormProps) => {
    ...
    useEffect(() => {
        ...
        if (updateResult.success) {
            ...
            router.push(`/custom-objects/${details?.customObjectId}`);
        } else {
