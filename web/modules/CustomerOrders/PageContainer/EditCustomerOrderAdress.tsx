...
import { EditCustomerOrderAddressForm } from '../Forms/EditCustomerOrderAddressForm';
...
const EditCustomerOrderAddress: FC<EditCustomerOrderProps> = ({
    id,
    router
}: EditCustomerOrderProps) => {
    ...
    const customerOrderDetailBreadCrumb = [
        ...itemRoutes,
        {
            ...
            path: '/customer-orders/' + data?.orderAddress?.orderId
        }
    ];
        ...
        <>
            {permissions ? (
                !modes.includes(ModeEnum.Update) ? (
                    ...
                    <>
                        <HeaderContent
                            title={`${t('menu:customer-order-address')} ${
...
EditCustomerOrderAddress.displayName = 'EditCustomerOrderAddress';

export { EditCustomerOrderAddress };
