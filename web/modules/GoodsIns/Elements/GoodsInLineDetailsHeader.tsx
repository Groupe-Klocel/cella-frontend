...
const GoodsInLineDetailsHeader: FC<ISingleItemProps> = (props: ISingleItemProps) => {
    ...
    const breadsCrumb = [
        ...
        {
            breadcrumbName: `${t('common:goods-in-line')}`
        }
    ];
    ...
    return (
        <HeaderContent
            title={`${t('common:goods-in-line')} ${title}`}
            routes={breadsCrumb}
            onBack={() => router.back()}
        />
    );
...
export { GoodsInLineDetailsHeader };
