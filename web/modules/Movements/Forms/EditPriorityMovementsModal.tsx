...
export interface EditPriorityMovementsModalProps {
    showModal: any;
    updateMovements: (input: any, setLoading: (loading: boolean) => void) => Promise<void>;
    loading: any;
}

const EditPriorityMovementsModal = ({
    showModal,
    updateMovements,
    loading
}: EditPriorityMovementsModalProps) => {
    ...
    const handleCancel = () => {
        ...
        showModal.setShowEditPriorityMovementsModal(false);
        form.resetFields();
    };
    ...
    const handleEdit = async () => {
        try {
            ...
            await updateMovements({ priority: priorityValue }, loading);
            showModal.setShowEditPriorityMovementsModal(false);
            form.resetFields();
            setIsEditLoading(false);
        } catch (error) {
    ...
    return (
        <Modal
            title={t('actions:edit-priority-movements-modal')}
            open={showModal.showEditPriorityMovementsModal}
            width={800}
...
export { EditPriorityMovementsModal };
