...
const AddLoadComponent: FC<IAddItemFormProps> = (props: IAddItemFormProps) => {
...
AddLoadComponent.displayName = 'AddLoadComponent';

export { AddLoadComponent };
