...
export const AddArticleTranslationsForm: FC<ISingleItemProps> = ({
    detailFields
}: ISingleItemProps) => {
    ...
    const keyLbl = t('common:language');
        ...
        form.validateFields()
            .then(() => {
                ...
                if (Object.entries(inputArgument).length !== 0) {
                    input_tmp['translation'] = Object.assign(new_element, inputArgument);
                } else {
                    input_tmp['translation'] = new_element;
                }
                updateArticle({
                    id: id,
                    input: { ...input_tmp }
