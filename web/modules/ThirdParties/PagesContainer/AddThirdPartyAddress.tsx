...
import { AddThirdPartyAddressForm } from '../Forms/AddThirdPartyAddressForm';
...
const AddThirdPartyAddress = (props: ISingleItemProps) => {
    ...
    const breadsCrumb = [
        ...
        {
            breadcrumbName: t('associate', { name: t('common:third-party-address') })
        }
    ];
        ...
        <>
            {permissions ? (
                !modes.includes(ModeEnum.Create) ? (
                    ...
                    <>
                        <HeaderContent
                            title={t('associate', { name: t('common:third-party-address') })}
                            routes={breadsCrumb}
                            onBack={() => router.push('/third-parties/' + props?.thirdPartyId)}
                        />
                        <StyledPageContent>
                            <AddThirdPartyAddressForm
