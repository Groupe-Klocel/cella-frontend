...
import { EditSchedulerConfigArgumentForm } from 'modules/SchedulerConfigs/Forms/EditSchedulerConfigArgumentForm';
...
const EditSchedulerConfigArgumentPage: PageComponent = () => {
    ...
    return (
        <>
            ...
            />
            <EditSchedulerConfigArgumentForm detailFields={detailFields} />
        </>
    );
};

EditSchedulerConfigArgumentPage.layout = MainLayout;

export default EditSchedulerConfigArgumentPage;
