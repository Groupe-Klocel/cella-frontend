...
const BlockLocationPage: PageComponent = () => {
    ...
    const pageTitle = `${t('common:location')} ${data?.name}`;
    // #endregions
    ...
    const headerData: HeaderData = {
        title: pageTitle,
        routes: breadCrumb,
        onBackRoute: `/blocks/${data?.blockId}`,
        actionsComponent: (
            <Space>
...
BlockLocationPage.layout = MainLayout;

export default BlockLocationPage;
