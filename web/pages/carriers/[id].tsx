...
import { CarrierModelV2 as model } from '@helpers';
...
import { CarrierDetailsExtra } from 'modules/Carriers/Elements/CarrierDetailsExtra';
...
const CarrierPage: PageComponent = () => {
    ...
    const pageTitle = `${t('common:carrier')} ${data?.name}`;
    // #endregions
    ...
    const headerData: HeaderData = {
        ...
        actionsComponent:
            data?.status !== configs.CARRIER_STATUS_CLOSED ? (
                <Space>
                ...
                <>
                    {data?.status == configs.CARRIER_STATUS_CLOSED ? (
                        <Button
                            onClick={() =>
                                confirmAction(
                                    { id, status: configs.CARRIER_STATUS_IN_PROGRESS },
                                    setReopenInfo,
                                    'enable'
                                )()
                            }
