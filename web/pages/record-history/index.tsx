                ...
                actionColumns={[
                    {
                        ...
                        key: 'actions',
                        render: (record: { sequenceId: string }) => (
                            <Space>
                                {modes.length > 0 && modes.includes(ModeEnum.Read) ? (
                                    <LinkButton
                                        icon={<EyeTwoTone />}
                                        path={pathParams(`${rootPath}/[id]`, record.sequenceId)}
                                    />
                                ) : (
                                    <></>
                                )}
...
RecordHistoryPages.layout = MainLayout;

export default RecordHistoryPages;
