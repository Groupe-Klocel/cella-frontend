...
import { StatusHistoryModelV2 as model } from '@helpers';
...
const StatusHistoryPages: PageComponent = () => {
...
StatusHistoryPages.layout = MainLayout;

export default StatusHistoryPages;
