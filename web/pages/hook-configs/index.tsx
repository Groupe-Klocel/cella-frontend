...
const HookConfigPages: PageComponent = () => {
    ...
    const headerData: HeaderData = {
        title: t('common:hook-configs'),
        routes: itemRoutes,
        actionsComponent:
            modes.length > 0 && modes.includes(ModeEnum.Create) ? (
                <LinkButton
                    title={t('actions:add2', { name: t('common:hook-config') })}
                    path={`${rootPath}/add`}
                    type="primary"
                />
            ) : null
...
HookConfigPages.layout = MainLayout;

export default HookConfigPages;
