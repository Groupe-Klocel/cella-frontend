...
const EditHookConfigArgumentPage: PageComponent = () => {
    ...
    return (
        <>
            ...
            />
            <EditHookConfigArgumentForm detailFields={detailFields} />
        </>
    );
};

EditHookConfigArgumentPage.layout = MainLayout;

export default EditHookConfigArgumentPage;
