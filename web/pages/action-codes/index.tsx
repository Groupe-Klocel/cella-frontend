...
import { actionCodeRoutes as itemRoutes } from 'modules/ActionCodes/Static/ActionCodeRoutes';
...
const StockStatusesPage: PageComponent = () => {
    ...
    const scopesList = Array.from(new Set(parameters.map((parameter: any) => parameter.scope)))
        ...
        .filter((scope) => scope.key === 'action_code');
    ...
    return (
        <>
            <AppHead title={t('common:code-actions')} />
            <ListComponent
