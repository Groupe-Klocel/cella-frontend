...
const EditPaymentMethodPage: PageComponent = (props) => {
    ...
    return (
        <>
            ...
            <AddEditItemComponent
                ...
                headerComponent={
                    <HeaderContent
                        title={`${t('actions:edit-payment-method')} ${data?.value}`}
                        routes={breadsCrumb}
                        onBack={() => router.back()}
                    />
                }
                comeFromFiltered={true}
                routeAfterSuccess={`/payment-methods/:id`}
            />
        </>
    );
};

EditPaymentMethodPage.layout = MainLayout;
