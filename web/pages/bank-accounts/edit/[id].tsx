...
const EditBankAccountPage: PageComponent = (props) => {
    ...
    return (
        <>
            ...
            <AddEditItemComponent
                ...
                headerComponent={
                    <HeaderContent
                        title={`${t('actions:edit-bank-account')} ${data?.value}`}
                        routes={breadsCrumb}
                        onBack={() => router.back()}
                    />
                }
                comeFromFiltered={true}
                routeAfterSuccess={`/bank-accounts/:id`}
            />
        </>
    );
};

EditBankAccountPage.layout = MainLayout;
