...
import { bankAccountsRoutes as itemRoutes } from 'modules/BankAccounts/Static/bankAccountsRoutes';
import { useAuth } from 'context/AuthContext';
import { FormDataType } from 'models/ModelsV2';
type PageComponent = FC & { layout: typeof MainLayout };

const BankAccountsPage: PageComponent = () => {
    ...
    const headerData: HeaderData = {
        title: t('common:bank-accounts'),
        routes: itemRoutes,
        actionsComponent:
            modes.length > 0 && modes.includes(ModeEnum.Create) ? (
                <LinkButton
                    title={t('actions:add2', { name: t('common:bank-account') })}
                    path={`${rootPath}/add`}
                    type="primary"
                />
            ) : null
...
BankAccountsPage.layout = MainLayout;
