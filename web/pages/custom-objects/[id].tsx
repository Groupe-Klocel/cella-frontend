...
import { CustomObjectModelV2 as model } from '@helpers';
...
import { CustomObjectDetailsExtra } from 'modules/CustomObjects/Elements/CustomObjectDetailsExtra';
...
const CustomObjectPage: PageComponent = () => {
    ...
    const pageTitle = `${t('common:custom-object')} ${data?.name}`;
            ...
            {id ? (
                <>
                    <ItemDetailComponent
                        ...
                        extraDataComponent={
                            <CustomObjectDetailsExtra
                                customObjectId={id}
                                customObjectName={data?.name}
                            />
                        }
                    />
...
CustomObjectPage.layout = MainLayout;
