...
export default async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    const { articleSetId: id } = req.body;
    ...
    const articleSetResponse = await graphqlRequestClient.request(query, variables, requestHeader);

    const tmp_context = {
        articleSet: articleSetResponse.articleSet
    };

    const renderDocumentVariables = {
        templateFilename: 'article_set.rml',
        context: tmp_context
    };
    ...
    console.log('error_time_font', result);
