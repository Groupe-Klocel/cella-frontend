...
export default async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    const barcodeResponse = await graphqlRequestClient.request(query, variables, requestHeader);

    const tmp_context = {
        articleLuBarcode: barcodeResponse.articleLuBarcode,
        labelSize,
        copies
    };

    const renderDocumentVariables = {
        templateFilename: 'barcode_label.rml',
        context: tmp_context
    };
