...
const ShippingModePage: PageComponent = () => {
    ...
    const pageTitle = `${t('common:shipping-mode')} ${data?.value}`;
    // #endregions
...
ShippingModePage.layout = MainLayout;

export default ShippingModePage;
