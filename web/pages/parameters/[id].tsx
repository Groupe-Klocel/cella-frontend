...
const ParameterPage: PageComponent = () => {
    ...
    const breadCrumb = [
        ...itemRoutes,
        {
            breadcrumbName: `${data?.scope} - ${data?.value}`
        }
    ];

    const pageTitle = `${t('common:parameter')} ${data?.scope} - ${data?.value}`;
    // #endregions
...
ParameterPage.layout = MainLayout;
