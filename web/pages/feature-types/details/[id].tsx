...
const FeatureTypeDetailPage: PageComponent = () => {
    ...
    const { id, parameterId } = router.query;
    ...
    const breadCrumb = [
        ...itemRoutes,
        {
            breadcrumbName: `${t('common:feature-type-detail')} ${
                data?.featureTypeText + ' / ' + data?.featureCode_name
            }`
        }
    ];

    const pageTitle = `${t('common:feature-type-detail')} ${
        data?.featureTypeText + ' / ' + data?.featureCode_name
    }`;
    // #endregions
    ...
    const headerData: HeaderData = {
        title: pageTitle,
        routes: breadCrumb,
        onBackRoute: `${rootPath}/${parameterId}`,
        actionsComponent: (
            <Space>
