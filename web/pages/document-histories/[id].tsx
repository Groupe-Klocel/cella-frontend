...
import { DocumentHistoryModelV2 as model } from '@helpers';
import { HeaderData } from 'modules/Crud/ItemDetailComponentV2';
...
import { DocumentHistoryDetailComponent } from 'modules/DocumentHistories/Elements/DocumentHistoryDetailComponent';

type PageComponent = FC & { layout: typeof MainLayout };

const DocumentHistoryPage: PageComponent = () => {
    ...
    const breadCrumb = [
        ...itemRoutes,
        {
            breadcrumbName: `${data?.documentName}`
        }
    ];

    const pageTitle = `${t('common:document-history')} ${data?.documentName}`;
    // #endregions
...
DocumentHistoryPage.layout = MainLayout;
