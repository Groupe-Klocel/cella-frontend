...
import { ArticlePriceModelV2 as model } from '@helpers';
...
const ArticlePricePages: PageComponent = () => {
    ...
    const headerData: HeaderData = {
        ...
        actionsComponent:
            modes.length > 0 && modes.includes(ModeEnum.Create) ? (
                <LinkButton
                    title={t('actions:add2', { name: t('common:article-price') })}
                    path={`${rootPath}/add`}
                    type="primary"
                />
            ) : null
...
ArticlePricePages.layout = MainLayout;

export default ArticlePricePages;
