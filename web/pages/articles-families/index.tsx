...
import { getModesFromPermissions, META_DEFAULTS, pathParams, cookie } from '@helpers';
...
import { articlesFamiliesRoutes as itemRoutes } from 'modules/ArticlesFamilies/Static/articlesFamiliesRoutes';
import { useAuth } from 'context/AuthContext';
import { FormDataType } from 'models/ModelsV2';
type PageComponent = FC & { layout: typeof MainLayout };

const ArticleFamilyPage: PageComponent = () => {
    ...
    const headerData: HeaderData = {
        title: t('common:articles-families'),
        routes: itemRoutes,
        actionsComponent:
            modes.length > 0 && modes.includes(ModeEnum.Create) ? (
                <LinkButton
                    title={t('actions:add2', { name: t('common:articles-family') })}
                    path={`${rootPath}/add`}
                    type="primary"
                />
            ) : null
...
ArticleFamilyPage.layout = MainLayout;
