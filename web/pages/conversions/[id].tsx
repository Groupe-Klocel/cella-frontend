...
import { ConversionModelV2 as model } from '@helpers';
...
const ConversionPage: PageComponent = () => {
    ...
    const pageTitle = `${t('common:conversion')} ${data?.typeText}`;
    // #endregions
...
ConversionPage.layout = MainLayout;
