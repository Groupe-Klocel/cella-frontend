...
const AddConfigurationPage: PageComponent = () => {
    ...
    return (
        <>
            ...
            <AddConfigParamComponent
                ...
                headerComponent={
                    <HeaderContent
                        title={t('actions:add-configuration')}
                        routes={addConfigurationsRoutes}
                        onBack={() => router.back()}
                    />
                }
                extraData={
                ...
                routeAfterSuccess={`/configurations`}
            />
        </>
    );
};

AddConfigurationPage.layout = MainLayout;
