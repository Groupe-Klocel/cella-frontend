...
// import { AddConfiguration } from 'modules/Configurations/PagesContainer/AddConfiguration';
import { useRouter } from 'next/router';
import { FC } from 'react';
import useTranslation from 'next-translate/useTranslation';
import { AddConfigurationExtraForm } from 'modules/Configurations/Forms/AddConfigurationExtraForm';
...
const AddParameterExtraPage: PageComponent = () => {
    ...
    return (
        <>
            ...
            />
            <AddConfigurationExtraForm urlBack={urlBack} />
        </>
    );
};
