...
const CreditLinePages: PageComponent = () => {
    ...
    const headerData: HeaderData = {
        title: t('common:credit-lines'),
        routes: itemRoutes,
        actionsComponent:
            modes.length > 0 && modes.includes(ModeEnum.Create) ? (
                <LinkButton
                    title={t('actions:add2', { name: t('common:credit-line') })}
                    path={`${rootPath}/add`}
                    type="primary"
                />
            ) : null
...
CreditLinePages.layout = MainLayout;

export default CreditLinePages;
