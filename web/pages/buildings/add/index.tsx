...
import { BuildingModelV2 } from '@helpers';
...
const AddBuildingPage: PageComponent = () => {
    const { t } = useTranslation();

    const router = useRouter();

    //enter between {} the default values for the form (for instance status "In progress"))
    const defaultValues = { status: configs.BUILDING_STATUS_IN_PROGRESS };
    ...
    return (
        <>
            ...
            <AddEditItemComponent
                ...
                routeAfterSuccess={`/buildings`}
            />
        </>
    );
};

AddBuildingPage.layout = MainLayout;
