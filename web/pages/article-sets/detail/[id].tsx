...
import { ArticleSetDetailModelV2 as model } from '@helpers';
...
const ArticleSetDetailPage: PageComponent = () => {
    ...
    const breadcrumb = [
        ...articleSetRoutes,
        {
            breadcrumbName: t('common:detail')
        }
    ];

    const title = data?.articleSet_name;
    const pageTitle = `${t('common:detail')} ${title}`;
...
ArticleSetDetailPage.layout = MainLayout;

export default ArticleSetDetailPage;
