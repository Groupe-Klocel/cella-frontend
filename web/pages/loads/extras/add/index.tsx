...
import { AddLoadExtraForm } from 'modules/Loads/Forms/AddLoadExtraForm';

type PageComponent = FC & { layout: typeof MainLayout };

const AddLoadExtraPage: PageComponent = () => {
    ...
    const breadsCrumb = [
        ...loadsRoutes,
        {
            breadcrumbName: `${router.query.loadName} / ${t('menu:add-extra-information')}`
        }
    ];
    return (
        <>
            ...
            />
            <AddLoadExtraForm detailFields={detailFields} />
        </>
    );
};

AddLoadExtraPage.layout = MainLayout;

export default AddLoadExtraPage;
