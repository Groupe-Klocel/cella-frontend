...
import { NotificationDetailComponent } from 'modules/Notifications/Elements/NotificationDetailComponent';

type PageComponent = FC & { layout: typeof MainLayout };

const NotificationPage: PageComponent = () => {
    ...
    const pageTitle = `${t('common:notification')} ${data?.name}`;
    // #endregions
...
NotificationPage.layout = MainLayout;
