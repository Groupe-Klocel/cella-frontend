...
import { SingleParameterModelV2 as model } from '@helpers';
import { HeaderData, ListComponent } from 'modules/Crud/ListComponentV2';
import { useTranslationWithFallback as useTranslation } from '@helpers';
import { FC, useEffect, useState } from 'react';
import { articlesSubFamiliesRoutes as itemRoutes } from 'modules/ArticlesSubFamilies/Static/articlesSubFamiliesRoutes';
import { useAuth } from 'context/AuthContext';
import { FormDataType } from 'models/ModelsV2';
type PageComponent = FC & { layout: typeof MainLayout };

const ArticleSubFamilyPage: PageComponent = () => {
    ...
    const headerData: HeaderData = {
        title: t('common:articles-subfamilies'),
        routes: itemRoutes,
        actionsComponent:
            modes.length > 0 && modes.includes(ModeEnum.Create) ? (
                <LinkButton
                    title={t('actions:add2', { name: t('common:articles-subfamily') })}
                    path={`${rootPath}/add`}
                    type="primary"
                />
            ) : null
    ...
    return (
        <>
            ...
            <ListComponent
                searchCriteria={{ scope: 'article_subfamily' }}
...
ArticleSubFamilyPage.layout = MainLayout;

export default ArticleSubFamilyPage;
