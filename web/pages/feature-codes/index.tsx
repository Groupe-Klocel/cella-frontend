...
import { FeatureCodeModelV2 as model } from 'models/FeatureCodeModelV2';
import { HeaderData, ListComponent } from 'modules/Crud/ListComponentV2';
import { useTranslationWithFallback as useTranslation } from '@helpers';
import { FC, useState } from 'react';
import { featureCodesRoutes as itemRoutes } from 'modules/FeatureCodes/Static/featureCodesRoutes';
type PageComponent = FC & { layout: typeof MainLayout };

const FeatureCodePages: PageComponent = () => {
    ...
    const headerData: HeaderData = {
        title: t('common:feature-codes'),
        routes: itemRoutes,
        actionsComponent:
            modes.length > 0 && modes.includes(ModeEnum.Create) ? (
                <LinkButton
                    title={t('actions:add2', { name: t('common:feature-code') })}
                    path={`${rootPath}/add`}
                    type="primary"
                />
            ) : null
...
FeatureCodePages.layout = MainLayout;

export default FeatureCodePages;
