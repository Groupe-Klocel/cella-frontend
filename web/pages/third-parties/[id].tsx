...
import { ThirdPartyModelV2 as model } from '@helpers';
...
import { ThirdPartyDetailsExtra } from 'modules/ThirdParties/Elements/ThirdPartyDetailsExtra';

type PageComponent = FC & { layout: typeof MainLayout };

const ThirdPartyPage: PageComponent = () => {
    ...
    const pageTitle = `${t('common:third-party')} ${data?.name}`;
    // #endregions
...
ThirdPartyPage.layout = MainLayout;
