...
import { RoundLineModelV2 as model } from '@helpers';
...
import { RoundLineDetailsExtra } from 'modules/Rounds/Elements/RoundLineDetailsExtra';
import configs from '../../../../common/configs.json';

type PageComponent = FC & { layout: typeof MainLayout };

const RoundLinePage: PageComponent = () => {
    ...
    const pageTitle = `${t('common:round-line')} ${data?.round_name} - ${t('common:line')} ${
        data?.lineNumber
    }`;
    // #endregions
...
RoundLinePage.layout = MainLayout;

export default RoundLinePage;
