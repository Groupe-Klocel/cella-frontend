...
import { AiConversationModelV2 as model } from '@helpers';
...
const AiConversationPages: PageComponent = () => {
    ...
    const headerData: HeaderData = {
        title: t('common:ai-conversations'),
        routes: itemRoutes,
...
AiConversationPages.layout = MainLayout;

export default AiConversationPages;
