...
export interface INumberOfHuPrintsModalV2Props {
    handlingUnits: any;
    showModal: any;
    documentName: string;
}

const NumberOfHuPrintsModalV2 = ({
    showModal,
    handlingUnits,
    documentName
}: INumberOfHuPrintsModalV2Props) => {
    ...
    const printData = async (inputForPrinting: any, copies: number, printer: string) => {
        ...
        const documentVariables = {
            ...
            printer,
            context: { handlingUnits: inputForPrinting, copies }
        };
    ...
    const onClickOk = () => {
        ...
        form.validateFields()
            .then(() => {
                ...
                printData(handlingUnits, formData.copies, formData.printer);
            })
            .catch((err) => {
                showError(t('messages:error-print-data'));
            });
...
export { NumberOfHuPrintsModalV2 };
