...
export interface ISingleQuotePrintModalProps {
    dataToPrint: any;
    showModal: any;
    documentName: string;
...
const SingleQuotePrintModal = ({
    showModal,
    dataToPrint,
    documentName,
    documentReference,
    customLanguage
}: ISingleQuotePrintModalProps) => {
    ...
    const handleCancel = () => {
        showModal.setShowSingleQuotePrintModal(false);
    };
    ...
    return (
        <Modal
            ...
            open={showModal.showSingleQuotePrintModal}
            onOk={onClickOk}
