...
export const ScanHuForm = ({
    ...
    useEffect(() => {
        if (handlingUnitBarcode && handlingUnitInfos.data) {
            if (handlingUnitInfos.data.handlingUnits?.count === 0) {
                ...
                showError(t('messages:hu-barcode-used'));
                form.resetFields();
    ...
    //ScanHU-1b: handle back to previous step settings
    const onBack = () => {
        setTriggerRender(!triggerRender);
