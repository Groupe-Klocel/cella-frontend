...
export const CheckFinalLocationPalletForm = ({
    process,
    stepNumber,
    ...
    //CheckFinalLocation-2: record values in securedLS once validated
    useEffect(() => {
        if (fetchResult) {
            const data: { [label: string]: any } = {};
            const type = fetchResult.checkFinalLocationPallet.locationComparison;
            data['chosenLocation'] = {
                ...destinationLocation,
                type
            };
