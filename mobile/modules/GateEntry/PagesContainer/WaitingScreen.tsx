...
// DESCRIPTION: gate-entry step 60 - waiting screen while the security agent
// reviews the entry (the page polls the appointment status).
...
export const WaitingScreen = ({ timedOut, onCancel }: IWaitingScreenProps) => {
    ...
    const extraMsg =
        elapsed > 60 ? t('common:waiting-verylong') : elapsed > 30 ? t('common:waiting-long') : t('common:waiting-extra');
