...
export interface IAutoValidatePAndPFullBoxProps {
    process: string;
    stepNumber: number;
...
export const AutoValidatePAndPFullBoxForm = ({
    process,
    stepNumber,
...
}: IAutoValidatePAndPFullBoxProps) => {
    ...
    //AutoValidatePAndPFullBox-1b: handle back to previous step settings
    const onBack = () => {
        setTriggerRender(!triggerRender);
