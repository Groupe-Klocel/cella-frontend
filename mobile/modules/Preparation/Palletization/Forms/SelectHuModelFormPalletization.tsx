...
import { GetHandlingUnitModelsQuery, useGetHandlingUnitModelsQuery } from 'generated/graphql';
...
export const SelectHuModelFormPalletization = ({
    process,
    stepNumber,
    ...
    useEffect(() => {
        if (huModelList) {
            ...
            const cData = huModelList?.data?.handlingUnitModels?.results;
            if (cData) {
                cData.forEach((item) => {
