...
export interface IValidatePickAndPackProps {
    process: string;
    stepNumber: number;
...
export const ValidatePickAndPackForm = ({
    process,
    stepNumber,
    trigger: { triggerRender, setTriggerRender },
    buttons,
    headerContent: { setHeaderContent }
}: IValidatePickAndPackProps) => {
    ...
    //ValidatePickAndPack-1b: handle back to previous step settings
    const onBack = () => {
        setTriggerRender(!triggerRender);
